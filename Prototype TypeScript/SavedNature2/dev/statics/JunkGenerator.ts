class JunkGenerator {
    ...
    private generateLevel2() : void{
        ...
        if(this.counter > this.updateTimout){
            ...
            // console.log("randomX junk =" + randomX);
            // console.log("randomY junk =" + randomY);
            let bush = new BackgroundObject({ imgSrc: this.assets.winterObjects.Tree2, x: randomX, y: randomYTree, frameHeight: 280, frameWidth: 228 }, this.getRandomFloat(1.05), this._game);
            let coin = new Coin(this._game, {imgSrc: this.assets.collectables.goldCoin,  x: randomX, y: randomY, frameHeight: 16, frameWidth: 16, maxFrame: 7, animationSpeed: 10, speed: 5});
            let Crate = new crate(this._game, { imgSrc: this.assets.winterObjects.IceBox, x: randomX, y: randomY, frameHeight: 101, frameWidth: 101, speed: 5 });
